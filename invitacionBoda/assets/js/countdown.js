const targetDate = new Date(2024, 6, 20, 14, 0, 0);
...
function updateTimeSection(sectionID, timeValue) {
  ...
  if(timeSegments.length == 3){
    updateTimeSegment(timeSegments[0], Math.floor(firstNumber / 10));
    updateTimeSegment(timeSegments[1], Math.floor(firstNumber % 10));
    updateTimeSegment(timeSegments[2], secondNumber);
  }else {
